...
## Objetivo principal
Construir una web que, en pocos segundos, comunique estas ideas:
1. Finbalo desarrolla soluciones digitales claras y bien pensadas.
2. Entiende problemas reales de negocio, no solo diseño visual.
3. Tiene una forma profesional, ordenada y confiable de iniciar un proyecto.
4. Su identidad visual es elegante, tecnológica y controlada.

## Prioridad general del sitio
Toda decisión de contenido, UX, diseño o estructura debe priorizar, en este orden:
1. **Claridad**
2. **Credibilidad**
3. **Conversión**
...
- No está dirigido a un público informal ni a marcas que buscan una estética experimental o demasiado creativa.
...
- juvenil en exceso
- “cripto”
- demasiado oscura como base obligatoria
...
4. Servicios
5. Por qué trabajar con nosotros
6. Soluciones
7. Proceso
8. Tecnologías
9. FAQ
...
- Si se necesita una sección tipo showcase, usar **Soluciones** y presentarla como **capacidades, tipos de sistemas o posibilidades de implementación**, no como trabajos realizados.
...
- Qué tipo de soluciones construimos.
- Cómo trabajamos.
...
- Testimonios falsos.
- Logos de clientes que no existen.
...
## Regla para la sección “Soluciones”
La sección “Soluciones” debe mostrar ejemplos de lo que Finbalo **puede construir**, por ejemplo:
- páginas web corporativas
- landing pages
- sistemas internos
- dashboards
- automatización de formularios, reservas o seguimientos
- portales de clientes
- herramientas operativas

Pero siempre redactado como:
- capacidades
- posibilidades
- tipos de solución
- escenarios de uso

Nunca redactarlo como:
- proyectos entregados
- casos de éxito reales si no existen
- implementaciones hechas para clientes específicos
...
- El navbar puede resaltar la sección activa según scroll si eso mejora orientación sin añadir ruido visual.
...
- `Organization`
- `FAQPage`
- `ProfessionalService` o estructura equivalente útil para el sitio

No meter schema por meterlo. Solo usarlo si está bien construido.

---

## Diseño e identidad visual
### Regla general de marca
La web debe ser **mayormente clara** para que el logo oscuro conserve contraste y presencia.
...
Finbalo puede incorporar este azul como **acento visual secundario**.
Ese azul **no debe convertirse en el color dominante del sistema**.
Su función es aportar identidad, jerarquía y un detalle tecnológico más reconocible.

### Uso correcto del azul `#3B82F6`
Usarlo principalmente en:
- palabras o fragmentos destacados dentro de títulos
- microacentos visuales en hero o encabezados clave
...
- subrayados, líneas de énfasis o realces breves
...
### Regla de temas
- El sitio debe funcionar especialmente bien en modo claro.
- El modo oscuro puede existir y debe verse elegante, legible y coherente.
...
- evitar negro puro como base total de la interfaz salvo detalles puntuales
...
## Reglas visuales
- Sitio mayormente claro.
- Navbar clara con logo oscuro en modo claro.
- Navbar oscura o translúcida con logo invertido en modo oscuro, manteniendo contraste y legibilidad.
- Hero claro con CTA oscuro o de alto contraste.
- Hero oscuro permitido si mantiene elegancia y claridad.
